...
/**
 * Componente visual que representa una animación de escritura ("Typing...").
 */
...
/**
 * Componente principal del chat de IA.
 * Permite la interacción del usuario con un asistente virtual que responde preguntas relacionadas con el autismo.
 */
const AIChat: React.FC = () => {
    // Estado que mantiene la lista de mensajes intercambiados en el chat.
    ...
    // Estado para almacenar el texto actual ingresado por el usuario.
    const [input, setInput] = useState('');

    // Estado que indica si el modelo está generando una respuesta.
    ...
    /**
     * Hace scroll automático hasta el final del chat.
     */
    const scrollToBottom = () => {
        messagesEndRef.current?.scrollIntoView({ behavior: 'smooth' });
    };

    // Hace scroll automático cada vez que los mensajes cambian.
    useEffect(() => {
        scrollToBottom();
    }, [messages]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Solicita una respuesta de la IA.
